...
public class TestSetFeatureValues extends TestCase {
  ...
  public void testSetFeatureValues1() throws Exception {
    ...
    String[] tofs = { "uima.tcas.DocumentAnnotation:language", "org.apache.uima.TestAnnot",
        "org.apache.uima.TestAnnot:testFeature0", "org.apache.uima.TestAnnot:testFeature1",
        "org.apache.uima.TestAnnot:testFeature2", "org.apache.uima.TestAnnot:testFeature3",
  ...
  /**
   * test all setFeature values for confidence and ruleID without have specified these values in the
   * concept file.
   * 
   * @throws Exception
   */
  public void testSetFeatureValuesForConfidenceAndRuleID() throws Exception {
    ...
    // define result interested in
    String[] tofs = { "org.apache.uima.TestAnnot", "org.apache.uima.TestAnnot:confidenceValue",
