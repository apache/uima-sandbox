 ...
 */
public class TestBeanshell extends TestCase
{
	private AnnotatorTester annotBshTester;
    ...
    {
      super.tearDown();
      this.annotBshTester = null;
    }
    
	public void testAnnotatorBeanshell() throws Exception
	{
		//retrieve Annotator sample text
		String text = AnnotatorTester.readFileContent(JUnitExtension.getFile("testdoc.txt"), "UTF-8");
		
		//execute sample text
		CAS cas = this.annotBshTester.performTest(text,"en");
