 ...
 * @generated */
public class NaturalFeature extends Entity {
  /** @generated
   * @ordered 
   */
  ...
  public String getCanonicalForm() {
    if (NaturalFeature_Type.featOkTst && ((NaturalFeature_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.NaturalFeature");
    return jcasType.ll_cas.ll_getStringValue(addr, ((NaturalFeature_Type)jcasType).casFeatCode_canonicalForm);}
  ...
  public void setCanonicalForm(String v) {
    if (NaturalFeature_Type.featOkTst && ((NaturalFeature_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.NaturalFeature");
    jcasType.ll_cas.ll_setStringValue(addr, ((NaturalFeature_Type)jcasType).casFeatCode_canonicalForm, v);}    
  }
