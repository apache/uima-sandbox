...
public class Movie extends Entity {
  ...
  public String getCanonicalForm() {
    if (Movie_Type.featOkTst && ((Movie_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.Movie");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Movie_Type)jcasType).casFeatCode_canonicalForm);}
  ...
  public void setCanonicalForm(String v) {
    if (Movie_Type.featOkTst && ((Movie_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.Movie");
    jcasType.ll_cas.ll_setStringValue(addr, ((Movie_Type)jcasType).casFeatCode_canonicalForm, v);}    
  }
