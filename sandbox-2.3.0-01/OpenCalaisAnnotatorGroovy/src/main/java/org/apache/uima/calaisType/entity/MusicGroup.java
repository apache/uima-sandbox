 ...
 * @generated */
public class MusicGroup extends Entity {
  /** @generated
   * @ordered 
   */
  ...
  public String getCanonicalForm() {
    if (MusicGroup_Type.featOkTst && ((MusicGroup_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.MusicGroup");
    return jcasType.ll_cas.ll_getStringValue(addr, ((MusicGroup_Type)jcasType).casFeatCode_canonicalForm);}
  ...
  public void setCanonicalForm(String v) {
    if (MusicGroup_Type.featOkTst && ((MusicGroup_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.MusicGroup");
    jcasType.ll_cas.ll_setStringValue(addr, ((MusicGroup_Type)jcasType).casFeatCode_canonicalForm, v);}    
  }
