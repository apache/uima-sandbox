 ...
 * @generated */
public class NaturalDisaster extends Entity {
  /** @generated
   * @ordered 
   */
  ...
  public String getCanonicalForm() {
    if (NaturalDisaster_Type.featOkTst && ((NaturalDisaster_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.NaturalDisaster");
    return jcasType.ll_cas.ll_getStringValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_canonicalForm);}
  ...
  public void setCanonicalForm(String v) {
    if (NaturalDisaster_Type.featOkTst && ((NaturalDisaster_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.NaturalDisaster");
    jcasType.ll_cas.ll_setStringValue(addr, ((NaturalDisaster_Type)jcasType).casFeatCode_canonicalForm, v);}    
  }
