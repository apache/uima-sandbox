...
public class ColoredTypeTreeLabelProvider extends LabelProvider 
									 implements ITableLabelProvider, ITableColorProvider, IFontProvider  
{
	...
	protected ColoredTypeTreeLabelProvider () {
	}
	
	public ColoredTypeTreeLabelProvider (StructuredViewer viewer) {
		super();
		_viewer = viewer;
	}

	public ColoredTypeTreeLabelProvider (StructuredViewer viewer, boolean showFullName) {
		super();
		_viewer = viewer;
...
//                }
    ...
    public Color getBackground(Object element, int columnIndex) {
        if ( element instanceof TypeNode ) {
            Object obj = ((TypeNode) element).getObject();
            if ( (obj instanceof TypeStyle) /* || (obj instanceof ColoredType)*/ ) {
