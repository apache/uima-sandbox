 ...
 * @generated */
public class Alliance_Type extends Relation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Alliance_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Alliance_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Alliance(addr, Alliance_Type.this);
  			   Alliance_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Alliance(addr, Alliance_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = Alliance.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.calaisType.relation.Alliance");
  ...
  public int getCompany(int addr) {
      ...
      jcas.throwFeatMissing("company", "org.apache.uima.calaisType.relation.Alliance");
  ...
  public String getStatus(int addr) {
      ...
      jcas.throwFeatMissing("status", "org.apache.uima.calaisType.relation.Alliance");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public Alliance_Type(JCas jcas, Type casType) {
    super(jcas, casType);
