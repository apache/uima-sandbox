 ...
 * @generated */
public class MusicAlbum_Type extends Entity_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (MusicAlbum_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = MusicAlbum_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new MusicAlbum(addr, MusicAlbum_Type.this);
  			   MusicAlbum_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new MusicAlbum(addr, MusicAlbum_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = MusicAlbum.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.calaisType.entity.MusicAlbum");
  ...
  public String getCanonicalForm(int addr) {
      ...
      jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.MusicAlbum");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public MusicAlbum_Type(JCas jcas, Type casType) {
    super(jcas, casType);
