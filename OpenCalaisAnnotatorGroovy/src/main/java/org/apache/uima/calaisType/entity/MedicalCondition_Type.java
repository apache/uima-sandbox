 ...
 * @generated */
public class MedicalCondition_Type extends Entity_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (MedicalCondition_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = MedicalCondition_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new MedicalCondition(addr, MedicalCondition_Type.this);
  			   MedicalCondition_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new MedicalCondition(addr, MedicalCondition_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = MedicalCondition.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.calaisType.entity.MedicalCondition");
  ...
  public String getCanonicalForm(int addr) {
      ...
      jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.MedicalCondition");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public MedicalCondition_Type(JCas jcas, Type casType) {
    super(jcas, casType);
