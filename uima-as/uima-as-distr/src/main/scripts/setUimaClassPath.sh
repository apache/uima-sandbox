...
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/activemq-core-5.0.0.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/activemq-optional-5.0.0.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/commons-httpclient-2.0.1.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/xstream-1.1.2.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/xmlpull-1.1.3.4d_b4_min.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/jetty-6.1.4.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/jetty-util-6.1.4.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/servlet-api-2.5-6.1.4.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/commons-logging-1.1.1.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/commons-pool-1.2.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/spring-2.0.6.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/xbean-spring-3.2-SNAPSHOT.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/optional/commons-collections-3.1.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/geronimo-jms_1.1_spec-1.0.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/geronimo-j2ee-management_1.0_spec-1.0.jar
