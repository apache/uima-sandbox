...
public class Facility extends Entity {
  ...
  public String getCanonicalForm() {
    if (Facility_Type.featOkTst && ((Facility_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.Facility");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Facility_Type)jcasType).casFeatCode_canonicalForm);}
  ...
  public void setCanonicalForm(String v) {
    if (Facility_Type.featOkTst && ((Facility_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.Facility");
    jcasType.ll_cas.ll_setStringValue(addr, ((Facility_Type)jcasType).casFeatCode_canonicalForm, v);}    
  }
