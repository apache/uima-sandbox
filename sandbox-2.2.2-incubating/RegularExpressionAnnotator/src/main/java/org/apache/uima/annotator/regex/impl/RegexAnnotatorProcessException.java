 ...
 * 
 */
public class RegexAnnotatorProcessException extends
    ...
    */
   public RegexAnnotatorProcessException(String aMessageKey, Object[] aArguments) {
      super(RegExAnnotator.MESSAGE_DIGEST, aMessageKey, aArguments);
   }
    ...
    *           if any
    */
   public RegexAnnotatorProcessException(String aMessageKey,
         Object[] aArguments, Throwable aCause) {
      super(RegExAnnotator.MESSAGE_DIGEST, aMessageKey, aArguments, aCause);
   }
    ...
    */
   public RegexAnnotatorProcessException(Throwable aCause) {
     super(aCause);
   }
