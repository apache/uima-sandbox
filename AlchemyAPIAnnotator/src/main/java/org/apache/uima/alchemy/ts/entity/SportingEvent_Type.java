 ...
 * @generated
 */
public class SportingEvent_Type extends TOP_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (SportingEvent_Type.this.useExistingInstance) {
        // Return eq fs instance if already created
        FeatureStructure fs = SportingEvent_Type.this.jcas.getJfsFromCaddr(addr);
        if (null == fs) {
          fs = new SportingEvent(addr, SportingEvent_Type.this);
          SportingEvent_Type.this.jcas.putJfsFromCaddr(addr, fs);
          return fs;
        }
        return fs;
      } else
        return new SportingEvent(addr, SportingEvent_Type.this);
    }
  };

  /** @generated */
  public final static int typeIndexID = SportingEvent.typeIndexID;
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getText(int addr) {
    if (featOkTst && casFeat_text == null)
      jcas.throwFeatMissing("text", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getCount(int addr) {
    if (featOkTst && casFeat_count == null)
      jcas.throwFeatMissing("count", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getRelevance(int addr) {
    if (featOkTst && casFeat_relevance == null)
      jcas.throwFeatMissing("relevance", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getDisambiguation(int addr) {
    if (featOkTst && casFeat_disambiguation == null)
      jcas.throwFeatMissing("disambiguation", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getSubType(int addr) {
    if (featOkTst && casFeat_subType == null)
      jcas.throwFeatMissing("subType", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getWebsite(int addr) {
    if (featOkTst && casFeat_website == null)
      jcas.throwFeatMissing("website", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getGeo(int addr) {
    if (featOkTst && casFeat_geo == null)
      jcas.throwFeatMissing("geo", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getDbpedia(int addr) {
    if (featOkTst && casFeat_dbpedia == null)
      jcas.throwFeatMissing("dbpedia", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getYago(int addr) {
    if (featOkTst && casFeat_yago == null)
      jcas.throwFeatMissing("yago", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getOpencyc(int addr) {
    if (featOkTst && casFeat_opencyc == null)
      jcas.throwFeatMissing("opencyc", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getUmbel(int addr) {
    if (featOkTst && casFeat_umbel == null)
      jcas.throwFeatMissing("umbel", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getFreebase(int addr) {
    if (featOkTst && casFeat_freebase == null)
      jcas.throwFeatMissing("freebase", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getCiaFactbook(int addr) {
    if (featOkTst && casFeat_ciaFactbook == null)
      jcas.throwFeatMissing("ciaFactbook", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getCensus(int addr) {
    if (featOkTst && casFeat_census == null)
      jcas.throwFeatMissing("census", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getGeonames(int addr) {
    if (featOkTst && casFeat_geonames == null)
      jcas.throwFeatMissing("geonames", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public String getMusicBrainz(int addr) {
    if (featOkTst && casFeat_musicBrainz == null)
      jcas.throwFeatMissing("musicBrainz", "org.apache.uima.alchemy.ts.entity.SportingEvent");
  ...
  public int getQuotations(int addr) {
    if (featOkTst && casFeat_quotations == null)
      jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.SportingEvent");
   ...
   * @generated
   */
  public SportingEvent_Type(JCas jcas, Type casType) {
    super(jcas, casType);
