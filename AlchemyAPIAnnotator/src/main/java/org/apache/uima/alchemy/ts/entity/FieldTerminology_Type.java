 ...
 * @generated
 */
public class FieldTerminology_Type extends TOP_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (FieldTerminology_Type.this.useExistingInstance) {
        // Return eq fs instance if already created
        FeatureStructure fs = FieldTerminology_Type.this.jcas.getJfsFromCaddr(addr);
        if (null == fs) {
          fs = new FieldTerminology(addr, FieldTerminology_Type.this);
          FieldTerminology_Type.this.jcas.putJfsFromCaddr(addr, fs);
          return fs;
        }
        return fs;
      } else
        return new FieldTerminology(addr, FieldTerminology_Type.this);
    }
  };

  /** @generated */
  public final static int typeIndexID = FieldTerminology.typeIndexID;
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getText(int addr) {
    if (featOkTst && casFeat_text == null)
      jcas.throwFeatMissing("text", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getRelevance(int addr) {
    if (featOkTst && casFeat_relevance == null)
      jcas.throwFeatMissing("relevance", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getCount(int addr) {
    if (featOkTst && casFeat_count == null)
      jcas.throwFeatMissing("count", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getDisambiguation(int addr) {
    if (featOkTst && casFeat_disambiguation == null)
      jcas.throwFeatMissing("disambiguation", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getSubType(int addr) {
    if (featOkTst && casFeat_subType == null)
      jcas.throwFeatMissing("subType", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getWebsite(int addr) {
    if (featOkTst && casFeat_website == null)
      jcas.throwFeatMissing("website", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getGeo(int addr) {
    if (featOkTst && casFeat_geo == null)
      jcas.throwFeatMissing("geo", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getDbpedia(int addr) {
    if (featOkTst && casFeat_dbpedia == null)
      jcas.throwFeatMissing("dbpedia", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getYago(int addr) {
    if (featOkTst && casFeat_yago == null)
      jcas.throwFeatMissing("yago", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getOpencyc(int addr) {
    if (featOkTst && casFeat_opencyc == null)
      jcas.throwFeatMissing("opencyc", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getUmbel(int addr) {
    if (featOkTst && casFeat_umbel == null)
      jcas.throwFeatMissing("umbel", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getFreebase(int addr) {
    if (featOkTst && casFeat_freebase == null)
      jcas.throwFeatMissing("freebase", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getCiaFactbook(int addr) {
    if (featOkTst && casFeat_ciaFactbook == null)
      jcas.throwFeatMissing("ciaFactbook", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getCensus(int addr) {
    if (featOkTst && casFeat_census == null)
      jcas.throwFeatMissing("census", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getGeonames(int addr) {
    if (featOkTst && casFeat_geonames == null)
      jcas.throwFeatMissing("geonames", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public String getMusicBrainz(int addr) {
    if (featOkTst && casFeat_musicBrainz == null)
      jcas.throwFeatMissing("musicBrainz", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
  ...
  public int getQuotations(int addr) {
    if (featOkTst && casFeat_quotations == null)
      jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.FieldTerminology");
   ...
   * @generated
   */
  public FieldTerminology_Type(JCas jcas, Type casType) {
    super(jcas, casType);
