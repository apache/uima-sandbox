...
public class Facility extends TOP {
  ...
  public String getRelevance() {
    ...
    return jcasType.ll_cas
            .ll_getStringValue(addr, ((Facility_Type) jcasType).casFeatCode_relevance);
  }
  ...
  public String getDisambiguation() {
    if (Facility_Type.featOkTst && ((Facility_Type) jcasType).casFeat_disambiguation == null)
      jcasType.jcas
              .throwFeatMissing("disambiguation", "org.apache.uima.alchemy.ts.entity.Facility");
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((Facility_Type) jcasType).casFeatCode_disambiguation);
  }
  ...
  public void setDisambiguation(String v) {
    if (Facility_Type.featOkTst && ((Facility_Type) jcasType).casFeat_disambiguation == null)
      jcasType.jcas
              .throwFeatMissing("disambiguation", "org.apache.uima.alchemy.ts.entity.Facility");
    jcasType.ll_cas.ll_setStringValue(addr, ((Facility_Type) jcasType).casFeatCode_disambiguation,
            v);
  }
  ...
  public String getCiaFactbook() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((Facility_Type) jcasType).casFeatCode_ciaFactbook);
  }
  ...
  public String getMusicBrainz() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((Facility_Type) jcasType).casFeatCode_musicBrainz);
  }
  ...
  public StringArray getQuotations() {
    if (Facility_Type.featOkTst && ((Facility_Type) jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.Facility");
    return (StringArray) (jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr,
            ((Facility_Type) jcasType).casFeatCode_quotations)));
  }
  ...
  public void setQuotations(StringArray v) {
    if (Facility_Type.featOkTst && ((Facility_Type) jcasType).casFeat_quotations == null)
      jcasType.jcas.throwFeatMissing("quotations", "org.apache.uima.alchemy.ts.entity.Facility");
    jcasType.ll_cas.ll_setRefValue(addr, ((Facility_Type) jcasType).casFeatCode_quotations,
  ...
  public String getQuotations(int i) {
    ...
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr,
            ((Facility_Type) jcasType).casFeatCode_quotations), i);
  ...
  public void setQuotations(int i, String v) {
    ...
    jcasType.ll_cas.ll_setStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr,
            ((Facility_Type) jcasType).casFeatCode_quotations), i, v);
  }
}
