...
public class Facility_Type extends Entity_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.calaisType.entity.Facility");
  ...
  public String getCanonicalForm(int addr) {
      ...
      jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.Facility");
