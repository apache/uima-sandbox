 ...
 * @generated */
public class MusicGroup_Type extends Entity_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  		     ...
  		     return fs;
        } else return new MusicGroup(addr, MusicGroup_Type.this);
  	  }
    };
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.calaisType.entity.MusicGroup");
  ...
  public String getCanonicalForm(int addr) {
      ...
      jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.MusicGroup");
