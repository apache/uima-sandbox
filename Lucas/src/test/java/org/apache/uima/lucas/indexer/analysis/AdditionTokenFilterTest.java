...
public class AdditionTokenFilterTest {
  ...
  public void testNext() throws Exception {
    ...
    AdditionTokenFilter filter =
            new AdditionTokenFilter(tokenStream, "prefix_", AdditionTokenFilter.PREFIX);
    ...
    filter = new AdditionTokenFilter(tokenStream, "_postfix", AdditionTokenFilter.POSTFIX);
