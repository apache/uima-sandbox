...
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/activemq-optional-5.0.0.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/commons-httpclient-3.1.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/xstream-1.1.2.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/xmlpull-1.1.3.4d_b4_min.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/jetty-6.1.7.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/jetty-util-6.1.7.jar
UIMA_CLASSPATH=$UIMA_CLASSPATH:$UIMA_HOME/apache-activemq-5.0.0/lib/servlet-api-2.5-6.1.7.jar
