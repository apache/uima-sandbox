...
usage() {
  ...
  echo "Usage: cd to uimaj-as-distr, then do src/main/build/signRelease.sh <version> <passphrase> (e.g., src/main/build/signRelease.sh uima-as-2.2.0-incubating-SNAPSHOT \"Your passphrase\")"
}
