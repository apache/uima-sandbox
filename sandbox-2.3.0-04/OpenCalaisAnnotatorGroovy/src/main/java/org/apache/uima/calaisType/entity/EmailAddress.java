...
public class EmailAddress extends Entity {
  ...
  public String getCanonicalForm() {
    if (EmailAddress_Type.featOkTst && ((EmailAddress_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.EmailAddress");
    return jcasType.ll_cas.ll_getStringValue(addr, ((EmailAddress_Type)jcasType).casFeatCode_canonicalForm);}
  ...
  public void setCanonicalForm(String v) {
    if (EmailAddress_Type.featOkTst && ((EmailAddress_Type)jcasType).casFeat_canonicalForm == null)
      jcasType.jcas.throwFeatMissing("canonicalForm", "org.apache.uima.calaisType.entity.EmailAddress");
    jcasType.ll_cas.ll_setStringValue(addr, ((EmailAddress_Type)jcasType).casFeatCode_canonicalForm, v);}    
  }
