 ...
 * @generated */
public class Buybacks_Type extends Relation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Buybacks_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Buybacks_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Buybacks(addr, Buybacks_Type.this);
  			   Buybacks_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Buybacks(addr, Buybacks_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = Buybacks.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.calaisType.relation.Buybacks");
  ...
  public int getCompany(int addr) {
      ...
      jcas.throwFeatMissing("company", "org.apache.uima.calaisType.relation.Buybacks");
  ...
  public String getDate(int addr) {
      ...
      jcas.throwFeatMissing("date", "org.apache.uima.calaisType.relation.Buybacks");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public Buybacks_Type(JCas jcas, Type casType) {
    super(jcas, casType);
